...
def analyze_sentiment_using_TFIDF_and_LogisticRegression(request,user_input):
    try:
...
result = analyze_sentiment_using_TFIDF_and_LogisticRegression(request,user_input)
print("\n" + "=" * 50 + "\n")
