...
def analyze_sentiment_using_BoW_and_RF(request,user_input):
    try:
        # Load only necessary columns for sentiment analysis (lazy loading)
...
result = analyze_sentiment_using_BoW_and_RF(request,user_input)
print("\n" + "=" * 50 + "\n")
